<template>
    <transition name="fade">
        <div v-show="show" @click="$emit('close')" class="absolute top-0 left-0 w-full h-full bg-black bg-opacity-80">
            <div class="flex justify-center mt-12">
                <div :class="['flex bg-yellow-100 mb-4 max-w-sm h-0 transform transition-all duration-1000', { 'h-auto': show }]">
                    <div class="w-16 bg-yellow-200">
                        <div class="p-4">
                    ...
                    <div class="w-auto text-grey-darker items-center p-4">
                        ...
                        <p class="leading-tight">
                            Dieser Name existiert bereits und kann nicht verwendet werden.
                        </p>
                    </div>
                </div>
            </div>     
